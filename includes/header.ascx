...
<link href="https://fonts.googleapis.com/css2?family=Oswald:wght@200;300;400;500;600;700&family=Red+Hat+Display:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,400;1,500;1,900&display=swap" rel="stylesheet">
...
<script>
	...
	document.write('<link href="<%= SkinPath %>css/layout.css?v=1.1'+ version_date.getMonth() + '.' + version_date.getDate() + '-' + Math.floor(Math.random() * 100) +'" type="text/css" rel="stylesheet"/>');
...
<header role="banner">	
    <div id="header" class="section_<%=PortalSettings.ActiveTab.BreadCrumbs(0).TabID %>">
        <div class="container">
            <div class="row">
